...
var ChildProcessTestRunnerDecorator = /** @class */ (function () {
    function ChildProcessTestRunnerDecorator(options, sandboxFileNames, sandboxWorkingDirectory, loggingContext) {
        this.worker = ChildProcessProxy_1.default.create(require.resolve("./" + ChildProcessTestRunnerWorker_1.ChildProcessTestRunnerWorker.name), loggingContext, options, { sandboxFileNames: sandboxFileNames }, sandboxWorkingDirectory, ChildProcessTestRunnerWorker_1.ChildProcessTestRunnerWorker);
    }
